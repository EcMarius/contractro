...
return [
    ...
    'auth' => [
        ...
        'use_value' => function_exists('setting') ? setting('api.scribe_auth_key', '') : '',
        ...
        'extra_info' => 'You can create API keys by visiting your <a href="/settings/api">API Settings</a> page in your dashboard. Include your API key in the <code>X-API-Key</code> header or as an <code>api_key</code> query parameter.',
    ],
