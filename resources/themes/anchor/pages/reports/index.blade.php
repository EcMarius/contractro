	...
	<x-app.container class="space-y-6">
		...
		<div>
			...
			<p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
				{{ __('common.generate_view_reports') }}
			</p>
		</div>
		...
		<div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
			<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('dashboard.total_revenue') }}</p>
			...
			<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('dashboard.active_contracts') }}</p>
			...
			<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('invoices.stats.total_invoices') }}</p>
				...
				<div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
					...
					<div>
						<label for="report_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
							{{ __('common.report_type') }} <span class="text-red-500">*</span>
						</label>
						<select name="report_type" id="report_type" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
							...
							<option value="revenue">{{ __('common.revenue_report') }}</option>
							<option value="profitability">{{ __('common.profitability_report') }}</option>
							<option value="contract_stats">{{ __('common.contract_stats_report') }}</option>
							<option value="client_analysis">{{ __('common.client_analysis_report') }}</option>
						</select>
					</div>
					...
					<div>
						<label for="period" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
							{{ __('common.period') }} <span class="text-red-500">*</span>
						</label>
						<select name="period" id="period" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
							<option value="">{{ __('common.select_period') }}</option>
							<option value="this_month">{{ __('common.this_month') }}</option>
							<option value="last_month">{{ __('common.last_month') }}</option>
							<option value="this_quarter">{{ __('common.this_quarter') }}</option>
							<option value="last_quarter">{{ __('common.last_quarter') }}</option>
							<option value="this_year">{{ __('common.this_year') }}</option>
							<option value="last_year">{{ __('common.last_year') }}</option>
							<option value="custom">{{ __('common.custom_period') }}</option>
						</select>
					</div>
				</div>
		...
		<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
			...
			<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
				<a href="{{ route('reports.generate', ['report_type' => 'revenue', 'period' => 'this_month']) }}" class="block p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-500 transition-colors">
					...
					<h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('common.revenue_current_month') }}</h3>
					<p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('common.detailed_revenue_report') }}</p>
				</a>
				...
				<a href="{{ route('reports.generate', ['report_type' => 'contract_stats', 'period' => 'this_year']) }}" class="block p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-500 transition-colors">
					...
					<h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('common.contract_statistics') }}</h3>
					<p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('common.current_year') }}</p>
				</a>
				...
				<a href="{{ route('reports.generate', ['report_type' => 'profitability', 'period' => 'last_quarter']) }}" class="block p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-500 transition-colors">
					...
					<h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('common.profitability') }}</h3>
					<p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('common.last_quarter') }}</p>
				</a>
				...
				<a href="{{ route('reports.generate', ['report_type' => 'client_analysis', 'period' => 'this_year']) }}" class="block p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-500 transition-colors">
					...
					<h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('common.client_analysis') }}</h3>
					<p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('common.current_year') }}</p>
				</a>
			</div>
		</div>
