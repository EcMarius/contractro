    ...
    <x-container>
        <div class="flex flex-wrap items-start justify-between pb-20">
            <div class="w-full md:w-1/6">
                ...
                @if(setting('site.footer_description'))
                    <p class="mt-4 text-sm text-zinc-600 dark:text-zinc-400 max-w-xs">
        ...
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray dark:border-zinc-700">
            <ul class="flex flex-wrap space-x-5 text-xs">
                <li class="mb-6 text-center flex-full lg:flex-none lg:mb-0 text-black dark:text-zinc-300">&copy; {{ date('Y') }} {{ setting('company_name', setting('site.title', 'EvenLeads')) }}. All rights reserved.</li>
                <li class="lg:ml-6">
                    <a href="/privacy" class="relative inline-block text-black dark:text-zinc-300 group">
            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                ...
                <li>
                    <a href="{{ setting('social_facebook') }}" target="_blank" class="text-zinc-600 hover:text-zinc-900 dark:hover:text-white">
                ...
                <li>
                    <a href="{{ setting('social_instagram') }}" target="_blank" class="text-zinc-600 hover:text-zinc-900 dark:hover:text-white">
                ...
                <li>
                    <a href="{{ setting('social_twitter') }}" target="_blank" class="text-zinc-600 hover:text-zinc-900 dark:hover:text-white">
                ...
                <li>
                    <a href="{{ setting('social_linkedin') }}" target="_blank" class="text-zinc-600 hover:text-zinc-900 dark:hover:text-white">
                ...
                <li>
                    <a href="{{ setting('social_github') }}" target="_blank" class="text-zinc-600 hover:text-zinc-900 dark:hover:text-white">
