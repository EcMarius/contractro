                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
                                        You have {{ $subscription->seats_purchased ?? 1 }} team locs available. Configurați organizația și invitați membri pentru colaborare.
                                    </p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-orange-800 dark:text-orange-300 mb-3">
                                        Planul dumneavoastră se va schimba de la <strong>{{ $subscription->plan->name }}</strong> to
